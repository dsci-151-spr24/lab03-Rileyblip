...
***There are `r nrow(nobel)` rows and `r ncol(nobel)` columns in the nobel dataset, and each row represents a nobel winner.***
...
***When these characteristics are filtered, it leaves me with `r nrow(nobel_living)` rows and `r ncol(nobel_living)` columns.***
...
3.  Create a faceted bar plot visualizing the relationship between the category of prize and whether the laureate was in the US when they won the nobel prize.
    ...
    ***There are more U.S. nobel winners than nobel winners of other countries.***
...
***President Donald Trump's new petition may damage the higher education and research in America, for their are some immigrants in the U.S. that have one the nobel prize, and these people could get deported back.***
...
***The country that is the most common is Germany with 20, and with Japan and U.K. following.***
